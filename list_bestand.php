...
<?php
	...
	$query = "SELECT * FROM `aufnahmebuch` WHERE `mandant`='$session_mandant' AND `papierkorb`='0' AND `vogel_anzahl`!=vogel_ausgewildert+vogel_euthanasiert+vogel_verstorben+vogel_weitergeleitet ORDER BY `datum` DESC";
